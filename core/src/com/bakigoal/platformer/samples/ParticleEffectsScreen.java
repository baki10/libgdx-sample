...
public class ParticleEffectsScreen extends AbstractScreen {
	...
	public void show() {
		...
		effects[3].load(Gdx.files.internal("data/explosion.particle"), Gdx.files.internal("data"));
