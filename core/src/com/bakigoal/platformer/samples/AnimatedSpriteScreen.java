...
public class AnimatedSpriteScreen extends AbstractScreen {
  ...
  public void render(float delta) {
    ...
    // rendering texture region animation
    ...
    // rendering texture region sprite animation
    Sprite sprite = new Sprite(cavemanFrame);
    sprite.setCenterX(2);
    sprite.setCenterY(3.7f);
    sprite.setScale(WORLD_TO_SCREEN, WORLD_TO_SCREEN);
