...
public class ViewportScreen extends AbstractScreen {
  private static final String TAG = "ViewportScreen";
  ...
  private void createViewports() {
    ...
    viewports.put("ExtendViewport (max)", new ExtendViewport(MIN_SCENE_WIDTH, MIN_SCENE_HEIGHT, MAX_SCENE_WIDTH, MAX_SCENE_HEIGHT, camera));
